...
class LimpiezaDuplicados: 
    ...
    def duplicados_generales(self) -> pl.DataFrame: 
    ...
    def duplicados_columna(self, col: str) -> pl.DataFrame: 
    ...
    def resetear_indice_dup_general(self) -> pl.DataFrame: 
        return self.duplicados_generales().with_row_index()
    
    def resetear_indice_dup_columna(self, col:str) -> pl.DataFrame: 
...
class PipelineLimpiezaDuplicados: 
    ...
    def PipelineDuplicados(self, col: str=None, estrategia: Optional[EstrategiaDuplicados]=None) -> pl.DataFrame: 
        try:
            match estrategia: 
