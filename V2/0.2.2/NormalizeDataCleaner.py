...
class NormalizacionTexto: 
    def __init__(self, df: DFWrapper) -> None: 
        ...
        self.df_categorico = df.df
    
    def caracteres_no_alfanumericos(self, col: str) -> Optional[pl.DataFrame]: 
    ...
    def espacios_extra(self, col: str) -> Optional[pl.DataFrame]: 
        self.validacion.columna_categorica(col=col)
        normalizacion = self.df_categorico.with_columns(
    ...
    def minusculas(self, col: str) -> Optional[pl.DataFrame]: 
        self.validacion.columna_categorica(col=col)
        normalizacion = self.df_categorico.with_columns(
    ...
    def mayusculas(self, col: str) -> Optional[pl.DataFrame]: 
        self.validacion.columna_categorica(col=col)
        normalizacion = self.df_categorico.with_columns(
    ...
    def espacios(self, col: str) -> Optional[pl.DataFrame]: 
        self.validacion.columna_categorica(col=col)
        normalizacion = self.df_categorico.with_columns(
    ...
    def eliminar_acentos(self, col: str) -> Optional[pl.DataFrame]: 
...
class PipelineNormalizacionTexto: 
    ...
    def PipelineTexto(self, col: str, estrategia: Optional[EstrategiasNormalizacionTexto]=None) -> Optional[pl.DataFrame]: 
        try:
            match estrategia: 
